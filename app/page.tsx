...
const SCENE2_URL = "/scene2.png"; // nouvelle photo (toi en train de chanter)
    ...
    <div className="min-h-screen bg-[#05050b] text-zinc-200 selection:bg-red-700/40 selection:text-zinc-50">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-6 leading-7 text-zinc-300">
              ...
              Entre désir brûlant, colère sourde et quête de liberté, elle transforme sa douleur en une arme sonore universelle.
              Artiste capable de mêler fragilité et rage, Liloo navigue entre RnB, rap et mélodies profondes.
              Sa voix habitée capture la violence des émotions et la renaissance qui en jaillit.
              Plus qu’un EP, c’est un combat intime devenu un manifeste universel.
            </p>
          </motion.div>
      ...
      <section id="story" className="relative py-20 sm:py-28">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="mt-6 leading-7 text-zinc-300">
            <em>Amour Létal</em> raconte le voyage d’une passion toxique.
            Un poison qui enivre, un combat qui détruit, une addiction qui attire — mais aussi une renaissance qui libère.
            À travers six morceaux liés entre eux comme les chapitres d’un roman, Liloo dévoile les étapes d’un parcours intime et universel :
            l’espoir, l’impuissance, le désir, la colère, la liberté, puis la puissance retrouvée.
          ...
          {[
            ...
            <li key={it.n} className="p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
              <div className="flex items-center gap-3 text-zinc-300">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-b from-zinc-600 to-zinc-800 text-zinc-50 border border-white/10">
                  {it.e}
                </span>
      ...
      <section id="gallery" className="max-w-6xl mx-auto px-6 pb-10 sm:pb-20">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="relative">
            <img src={SCENE2_URL} alt="Liloo en scène" className="w-full h-full object-cover rounded-2xl ring-1 ring-white/10" />
            <div className="absolute -inset-2 -z-10 bg-gradient-to-tr from-red-700/20 to-transparent blur-2xl rounded-3xl" />
          </div>
        </div>
      </section>
          ...
          <div className="mt-8 grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a href="https://instagram.com/liloomusikoff" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">Instagram</a>
                ...
                <a href="https://open.spotify.com/search/Liloo%20Queen" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">Spotify</a>
              </div>
            </div>
          </div>
          <div className="mt-10 text-xs text-zinc-500">
            © {new Date().getFullYear()} Liloo — Amour Létal · EPK
          </div>
        </div>
      </footer>
    </div>

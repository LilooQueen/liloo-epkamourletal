...
const SCENE_URL = "/scene.png";   // première photo de scène
const SCENE2_URL = "/scene2.png"; // deuxième photo de scène (toi en train de chanter)
      ...
      <section id="bio" className="max-w-6xl mx-auto px-6 py-16 sm:py-24">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative">
            <img src={SCENE_URL} alt="Liloo sur scène" className="w-full rounded-2xl shadow-2xl ring-1 ring-white/10" />

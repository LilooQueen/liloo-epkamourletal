...
const PORTRAIT_URL = "/portrait.png"; // BIO : portrait
const SCENE_URL = "/scene.png";       // VISUELS : scène 1
const SCENE2_URL = "/scene2.png";     // VISUELS : scène 2
      ...
      <section className="relative pt-14">
        <div className="relative h-[80vh] w-full">
          ...
          <div className="absolute inset-x-0 bottom-0 max-w-6xl mx-auto px-6 pb-10">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }} className="mt-3 max-w-2xl text-zinc-300 italic">
      ...
      <section id="bio" className="max-w-6xl mx-auto px-6 py-16 sm:py-24">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative">
            <img src={PORTRAIT_URL} alt="Portrait presse de Liloo" className="w-full rounded-2xl shadow-2xl ring-1 ring-white/10" />

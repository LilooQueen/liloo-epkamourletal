          ...
          <div className="mt-8 grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <a href="https://open.spotify.com/artist/TON_ID_ARTISTE" target="_blank" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">Spotify</a>
              </div>
            </div>

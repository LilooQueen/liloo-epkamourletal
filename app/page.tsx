    ...
    <div className="min-h-screen bg-[#05050b] text-zinc-200 selection:bg-red-700/40 selection:text-zinc-50">
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-black/40 border-b border-zinc-800/60">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <a href="#contacts" className="px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-zinc-300 to-zinc-500 text-black shadow hover:opacity-90">
            EPK
          </a>
        </nav>
      </header>
      ...
      <section className="relative pt-14">
        <div className="relative h-[80vh] w-full">
          <img src="/cover.png" alt="Cover Amour Létal" className="h-full w-full object-cover opacity-80" />
      ...
      <section id="bio" className="max-w-6xl mx-auto px-6 py-16 sm:py-24">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative">
            <img src="/portrait.png" alt="Portrait Liloo" className="w-full rounded-2xl shadow-2xl ring-1 ring-white/10" />
      ...
      <section id="gallery" className="max-w-6xl mx-auto px-6 pb-10 sm:pb-20">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 relative">
            <img src="/portrait.png" alt="Portrait Liloo" className="w-full h-full object-cover rounded-2xl ring-1 ring-white/10" />
            <div className="absolute -inset-2 -z-10 bg-gradient-to-tr from-red-700/20 to-transparent blur-2xl rounded-3xl" />
          </div>
          <div className="relative">
            <img src="/scene.png" alt="Liloo en scène" className="w-full h-full object-cover rounded-2xl ring-1 ring-white/10" />
            <div className="absolute -inset-2 -z-10 bg-gradient-to-tr from-red-700/20 to-transparent blur-2xl rounded-3xl" />
          </div>
        </div>
      </section>
          ...
          <div className="mt-8 grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a href="https://instagram.com/liloomusikoff" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">
                  Instagram
                </a>
                <a href="https://youtube.com/@liloomusikoff" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">
                  YouTube
                </a>
                <a href="https://open.spotify.com/artist/TON_ID_ARTISTE" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 border border-white/10">
                  Spotify
                </a>
              </div>
            </div>
